...
RTF сообщение зашифровано в Base64 и Gzip. Расшифрованный формат выглядит примерно так:
...
В случае с авторизацией Plain Text должен быть запакован в Base64 и составляться так: 
